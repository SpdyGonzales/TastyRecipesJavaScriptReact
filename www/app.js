...
var Recipes = function (_Component) {
	...
	_createClass(Recipes, [{
		...
		key: 'getRecipes',
		value: function getRecipes(props) {
			var _this2 = this;

			// byt detta mot PostData? o kanske PostData kan heta RequestData
			return fetch('src/server/util/xml-service.php?recipe=' + props.match.params.id).then(function (response) {
...
var CommentSection = function (_Component) {
    ...
    _createClass(CommentSection, [{
        ...
        value: function getComments(recipeSite) {
            ...
            return fetch('src/server/util/comments.php?recipe=' + this.props.recipeSite).then(function (response) {
                response.json().then(function (data) {
                    _this2.setState({
                        commentList: data
                    });
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                this.state.commentList ? _react2.default.createElement(
                    'ul',
                    { className: 'comments-list', id: 'comments' },
                    _react2.default.createElement(
                        'div',
                        { className: 'comment' },
