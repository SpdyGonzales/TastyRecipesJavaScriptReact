...
var _PageNotFound = __webpack_require__(91);
	...
	return _react2.default.createElement(
		...
		_react2.default.createElement(
			...
			_react2.default.createElement(
				...
				_react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/recipes/:id', component: _Recipes2.default }),
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									'li',
									null,
									_react2.default.createElement(MenuLink, { className: 'link', to: '/recipes/pancake', label: 'Pancakes' })
								),
								_react2.default.createElement(
									'li',
									null,
		...
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'div',
					{ className: 'flexbox' },
					_react2.default.createElement('div', { id: 'picmeat', className: 'poster', title: 'Meatballs' }),
					_react2.default.createElement('div', { className: 'spacer' }),
					_react2.default.createElement('div', { id: 'picpancake', className: 'poster', title: 'Pancakes' })
				),
				_react2.default.createElement('div', { className: 'spacer' }),
				_react2.default.createElement(
					'div',
...
var _x2js = __webpack_require__(87);
...
var Recipes = function (_Component) {
	...
	_createClass(Recipes, [{
		key: 'componentWillMount',
		value: function componentWillMount() {
			console.log('mounted recipes', this.props);
			this.getRecipes();
		}
	}, {
		key: 'getRecipes',
		value: function getRecipes() {
			...
			return fetch('../classes/xml/recipes.xml').then(function (response) {
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				this.state.recipesData ? JSON.stringify(this.state.recipeData) : _react2.default.createElement(
					'h2',
					null,
					'Laddar'
				)
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'a',
								{ id: 'picpancake', title: 'Pancake Day', className: 'background', href: 'pancake.php' },
								'10'
							)
						),
						_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'a',
								{ id: 'picmeat', title: 'Meatballs Day', className: 'background', href: 'meatballs.php' },
								'20'
							)
						),
						_react2.default.createElement(
