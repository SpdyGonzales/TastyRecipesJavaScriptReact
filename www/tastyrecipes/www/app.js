...
function PostData(path, userData, method) {
    var BaseURL = '/tastyrecipes/src/server/util/';
...
_reactDom2.default.render(_react2.default.createElement(_router2.default, null), document.getElementById('app-root'));
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var _typeof=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj;}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};if(process.env.NODE_ENV!=="production"){(function(){'use strict';var React=__webpack_require__(0);var invariant=__webpack_require__(7);var warning=__webpack_require__(13);var ExecutionEnvironment=__webpack_require__(23);var _assign=__webpack_require__(6);var emptyFunction=__webpack_require__(5);var EventListener=__webpack_require__(24);var getActiveElement=__webpack_require__(25);var shallowEqual=__webpack_require__(26);var containsNode=__webpack_require__(27);var focusNode=__webpack_require__(28);var emptyObject=__webpack_require__(12);var checkPropTypes=__webpack_require__(15);var hyphenateStyleName=__webpack_require__(49);var camelizeStyleName=__webpack_require__(51);/**
 * WARNING: DO NOT manually require this module.
 * This is a replacement for `invariant(...)` used by the error code system
 * and will _only_ be required by the corresponding babel pass.
 * It always throws.
	...
	_createClass(AppRouter, [{
		...
		value: function render() {
			return _react2.default.createElement(
				...
				{ basename: '/tastyrecipes/www' },
				_react2.default.createElement(
					'div',
					null,
					_react2.default.createElement(_Header2.default, { setUserData: this.updateUserData }),
					_react2.default.createElement(
						_reactRouterDom.Switch,
						null,
						_react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/home', component: _Home2.default }),
						_react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/recipes/:id', component: _Recipes2.default, userData: this.state.userData }),
...
var MenuLink = function MenuLink(_ref) {
	var label = _ref.label,
	    to = _ref.to,
	    activeOnExact = _ref.activeOnExact;
	return _react2.default.createElement(_reactRouterDom.Route, { path: to, exact: activeOnExact, children: function children(_ref2) {
			var match = _ref2.match;
			return _react2.default.createElement(
				'div',
				{ className: match ? 'activepg' : '' },
				_react2.default.createElement(
...
var Header = function (_Component) {
	...
	_createClass(Header, [{
		key: 'updateLogin',
		value: function updateLogin(data) {
			var _this2 = this;
			...
			this.setState({
				...
				_this2.props.setUserData(_this2.state.userData);
			});
		}
	}, {
		key: 'render',
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'li',
							null,
							_react2.default.createElement(MenuLink, { to: '/home', label: 'Home' })
						),
						_react2.default.createElement(
							'li',
							null,
							_react2.default.createElement(MenuLink, { to: '/Calendar', label: 'Calendar' })
						),
						_react2.default.createElement(
							'li',
							null,
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									'li',
									null,
									_react2.default.createElement(MenuLink, { className: 'link', to: '/recipes/pancakes', label: 'Pancakes' })
								),
								_react2.default.createElement(
									'li',
									null,
									_react2.default.createElement(MenuLink, { to: '/recipes/meatballs', label: 'Meatballs' })
								)
							)
						),
						this.state.isLoggedIn ? _react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									'li',
									null,
									_react2.default.createElement(_Login2.default, { loginCallback: this.updateLogin }),
...
var _PostData = __webpack_require__(37);
...
var Signup = function (_Component) {
  ...
  _createClass(Signup, [{
    ...
    value: function signup(data) {
      console.log(data);
      if (data) {
        (0, _PostData.PostData)('signup.php', data).then(function (result) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement('input', { type: 'text', name: 'firstname', placeholder: 'firstname' }),
        _react2.default.createElement('br', null),
        _react2.default.createElement('input', { type: 'text', name: 'lastname', placeholder: 'lastname' }),
        _react2.default.createElement('br', null),
...
var Login = function (_Component) {
	...
	_createClass(Login, [{
		...
		value: function login(event) {
			...
			if (event) {
				(0, _PostData.PostData)('login.php', this.state, 'POST').then(function (result) {
					result.json().then(function (data) {
						console.log('result', data);
						_this2.props.loginCallback(data);
        ...
        */
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement('input', { type: 'text', name: 'uid', placeholder: 'Username', onChange: this.handleInputChange }),
				_react2.default.createElement('input', { type: 'password', name: 'pwd', placeholder: 'Password', onChange: this.handleInputChange }),
				_react2.default.createElement(
					'button',
					{ type: 'submit' },
					'LOGIN'
...
var Home = function (_Component) {
	...
	_createClass(Home, [{
		...
		value: function render() {
			return _react2.default.createElement(
				'article',
				{ id: 'home', className: 'home--wrapper' },
				_react2.default.createElement(
					'div',
				...
				_react2.default.createElement(
					'div',
					{ className: 'flexbox' },
					_react2.default.createElement('div', { id: 'meatballs', className: 'poster', title: 'Meatballs' }),
					_react2.default.createElement('div', { className: 'spacer' }),
					_react2.default.createElement('div', { id: 'pancakes', className: 'poster', title: 'Pancakes' })
				),
				_react2.default.createElement('div', { className: 'spacer' }),
				_react2.default.createElement(
					'div',
					{ className: 'flexbox' },
					_react2.default.createElement('div', { id: 'picsoup', className: 'poster', title: 'Brocolli Soup' }),
					_react2.default.createElement('div', { className: 'spacer' }),
					_react2.default.createElement('div', { id: 'piccarrot', className: 'poster', title: 'Fresh Carrots' })
				),
				_react2.default.createElement('div', { className: 'endspacer' })
			);
		}
	}]);
...
// module
exports.push([module.i, ".welcometitle {\n    text-align: center;\n    margin: 0;\n    margin-bottom: 200px;\n    margin-top: 250px;\n}\n.welcometitle h1{\n  font-size: 35px;\n}\n.welcometitle span{\n\tfont-size: 15px;\n\tdisplay: block;\n}\n\n.flexbox{\n  display:flex;\n  justify-content:center;\n  margin:auto;\n}\n.spacer{\n  margin: 11px 6px;\n}\n.endspacer{\n\tmargin: 50px 10px;\n}\n.poster{\n  background-size:cover;\n  background-position:center center;\n  height:600px;\n  width:100%;\n}\n.home--wrapper{\n\tmargin: 0 12px;\n}", ""]);
...
// module
exports.push([module.i, "/* Downloaded from http://meyerweb.com/eric/thoughts/2007/05/01/reset-reloaded/ */\n\nhtml, body, div, span, applet, object, iframe,\nh1, h2, h3, h4, h5, h6, p, blockquote, pre,\na, abbr, acronym, address, big, cite, code,\ndel, dfn, em, font, img, ins, kbd, q, s, samp,\nsmall, strike, strong, sub, sup, tt, var,\ndl, dt, dd, ol, ul, li,\nfieldset, form, label, legend,\ntable, caption, tbody, tfoot, thead, tr, th, td {\n\tmargin: 0;\n\tpadding: 0;\n\tborder: 0;\n\toutline: 0;\n\tfont-weight: inherit;\n\tfont-style: inherit;\n\tfont-size: 100%;\n\tfont-family: inherit;\n\tvertical-align: baseline;\n}\n\n/* remember to define focus styles! */\n:focus {\n\toutline: 0;\n}\n\nbody {\n\tline-height: 1;\n\tcolor: black;\n\tbackground: white;\n}\n\nol, ul {\n\tlist-style: none;\n}\n\n/* tables still need 'cellspacing=\"0\"' in the markup */\ntable {\n\tborder-collapse: separate;\n\tborder-spacing: 0;\n}\n\ncaption, th, td {\n\ttext-align: left;\n\tfont-weight: normal;\n}\n\nblockquote:before, blockquote:after,\nq:before, q:after {\n\tcontent: \"\";\n}\n\nblockquote, q {\n\tquotes: \"\" \"\";\n}", ""]);
...
var _x2js = __webpack_require__(90);

var _x2js2 = _interopRequireDefault(_x2js);

var _CommentSection = __webpack_require__(91);
...
console.log(_x2js2.default);

var xml2JsonParser = new _x2js2.default();
...
var Recipes = function (_Component) {
	...
	_createClass(Recipes, [{
		...
		value: function getRecipes() {
			...
			return fetch('tastyrecipes/src/server/util/xml-service.php?recipe=' + this.props.match.params.id).then(function (response) {
		...
		key: 'render',
		value: function render() {
			console.log('recipe render findthis asdfadsf', this.state.recipesData);
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					recipeData ? _react2.default.createElement(
						'div',
						{ className: 'flexbox' },
						_react2.default.createElement('div', { id: this.props.match.params.id, className: 'poster', title: 'Meatballs with fresh salad' }),
						_react2.default.createElement(
							'div',
							{ className: 'textpos' },
							_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									...
									_react2.default.createElement(
										'ul',
										null,
										recipeData.ingredient.li.map(function (ingredient, index) {
											return _react2.default.createElement(
												'li',
												null,
												ingredient
								...
								_react2.default.createElement(
									...
									_react2.default.createElement(
										'ul',
										null,
										recipeData.recipetext.li.map(function (recipetext, index) {
											return _react2.default.createElement(
												'li',
												null,
												recipetext
					...
					_react2.default.createElement(_CommentSection2.default, { recipeSite: this.props.match.params.id })
				)
			);
		}
	}]);
...
var CommentSection = function (_Component) {
    ...
    _createClass(CommentSection, [{
        ...
        key: 'getComments',
        value: function getComments(recipeSite) {
            var _this2 = this;

            return fetch('tastyrecipes/src/server/util/comments.php?recipe=' + this.props.recipeSite).then(function (response) {
                response.json().then(function (data) {
                    _this2.setState({
                        commentList: data
                    });
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'h2',
                        null,
                        'Comment section - Give your feedback!'
                    ),
                    _react2.default.createElement(
                        'form',
                        { onSubmit: this.submitComment },
                        _react2.default.createElement('input', { type: 'hidden', name: 'uid', value: this.props.userData && this.props.userData.uid }),
                        _react2.default.createElement('input', { type: 'hidden', name: 'date', value: new Date('Y-m-d H:i:s') }),
                        _react2.default.createElement('textarea', { name: 'message' }),
                        _react2.default.createElement('input', { type: 'submit', name: 'commentSubmit' })
                    )
                ),
                this.state.commentList ? _react2.default.createElement('ul', { className: 'comments-list', id: 'comments' }) : _react2.default.createElement('div', null)
            );
        }
    }]);
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!./recipes.css", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!./recipes.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'a',
								{ id: 'pancakes', title: 'Pancake Day', className: 'background', href: 'pancake.php' },
								'10'
							)
						),
						_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'a',
								{ id: 'meatballs', title: 'Meatballs Day', className: 'background', href: 'meatballs.php' },
								'20'
							)
						),
						_react2.default.createElement(
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!./mainstyle.css", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!./mainstyle.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
module.exports = __webpack_require__.p + "c858c29797cdfc94ec8bd5e536138237.jpg";

/***/ }),
/* 101 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "996ebca31d601ef670bd6c31d259153e.jpg";

/***/ }),
/* 102 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "9284aac03659d04b2bee5ebcb885de13.jpg";

/***/ }),
/* 103 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "45b6c7ab14a1014992aeda667ccfcb69.jpg";
